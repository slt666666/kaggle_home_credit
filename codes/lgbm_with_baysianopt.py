...
def clean_data(data):
    ...
    features = ['PREV_prev AMT_GOODS_PRICE - AMT_CREDIT_MIN', 'POS_MONTHS_BALANCE_MAX', 'ACTIVE_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MEAN', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_SUM', 'PREV_DAYS_DECISION_MIN', 'POS_SK_ID_PREV_SUM', 'BURO_CREDIT_ACTIVE_Closed_MEAN', 'APPROVED_AMT_APPLICATION_MIN', 'app AMT_INCOME_TOTAL / AMT_ANNUITY', 'BURO_bureau DAYS_CREDIT - CREDIT_DAY_OVERDUE_MEAN', 'PREV_DAYS_LAST_DUE_MIN', 'ACTIVE_DAYS_CREDIT_UPDATE_MEAN', 'app DAYS_EMPLOYED / DAYS_BIRTH', 'ACTIVE_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MAX', 'POS_SK_DPD_MAX', 'EXT_SOURCE_1', 'ACTIVE_AMT_CREDIT_SUM_VAR', 'INS_ins AMT_INSTALMENT - AMT_PAYMENT_VAR', 'PREV_PRODUCT_COMBINATION_Cash X-Sell: high_MEAN', 'APPROVED_AMT_CREDIT_MAX', 'APPROVED_AMT_APPLICATION_SUM', 'ACTIVE_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MIN', 'ACTIVE_DAYS_CREDIT_MAX', 'NAME_INCOME_TYPE', 'YEARS_BUILD_AVG', 'PREV_DAYS_DECISION_MAX', 'BURO_AMT_CREDIT_MAX_OVERDUE_SUM', 'CLOSED_SK_ID_BUREAU_SIZE_MEAN', 'BURO_DAYS_CREDIT_MIN', 'LANDAREA_MODE', 'BURO_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_SUM', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MAX', 'INS_AMT_PAYMENT_SUM', 'CLOSED_DAYS_CREDIT_MEAN', 'PREV_DAYS_LAST_DUE_1ST_VERSION_MIN', 'CARD_CNT_DRAWINGS_CURRENT_MAX', 'CLOSED_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MEAN', 'app OWN_CAR_AGE / DAYS_EMPLOYED', 'PREV_prev DAYS_FIRST_DRAWING - DAYS_FIRST_DUE_VAR', 'INS_AMT_PAYMENT_VAR', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_SUM', 'CLOSED_STATUS_1_MEAN_MEAN', 'AMT_CREDIT', 'INS_DAYS_INSTALMENT_MIN', 'CARD_CNT_DRAWINGS_CURRENT_MEAN', 'CARD_AMT_PAYMENT_CURRENT_VAR', 'PREV_DAYS_DECISION_VAR', 'POS_CNT_INSTALMENT_MIN', 'BURO_DAYS_CREDIT_UPDATE_MEAN', 'BURO_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MAX', 'POS_MONTHS_BALANCE_SUM', 'BURO_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MIN', 'BURO_DAYS_CREDIT_MEAN', 'PREV_prev DAYS_TERMINATION less -500_MEAN', 'POS_SK_DPD_DEF_SUM', 'REFUSED_DAYS_DECISION_MEAN', 'app EXT_SOURCE_2 * EXT_SOURCE_3', 'PREV_RATE_DOWN_PAYMENT_MAX', 'ACTIVE_DAYS_CREDIT_SUM', 'REFUSED_CNT_PAYMENT_MEAN', 'BURO_AMT_CREDIT_MAX_OVERDUE_MAX', 'BURO_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_SUM', 'CLOSED_DAYS_CREDIT_MAX', 'OCCUPATION_TYPE', 'FLAG_WORK_PHONE', 'APPROVED_prev AMT_APPLICATION / AMT_CREDIT_MEAN', 'REFUSED_AMT_APPLICATION_VAR', 'CLOSED_DAYS_CREDIT_SUM', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MIN', 'REFUSED_SK_ID_PREV_MIN', 'INS_AMT_INSTALMENT_VAR', 'APPROVED_DAYS_DECISION_SUM', 'POS_pos CNT_INSTALMENT more CNT_INSTALMENT_FUTURE_VAR', 'ACTIVE_bureau DAYS_CREDIT - CREDIT_DAY_OVERDUE_MAX', 'ACTIVE_AMT_CREDIT_MAX_OVERDUE_MEAN', 'ACTIVE_AMT_CREDIT_SUM_OVERDUE_MEAN', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MAX', 'PREV_DAYS_FIRST_DUE_VAR', 'REFUSED_prev AMT_APPLICATION / AMT_CREDIT_MIN', 'APPROVED_AMT_ANNUITY_MIN', 'ACTIVE_CREDIT_TYPE_Microloan_MEAN', 'CARD_card AMT_DRAWINGS_CURRENT - AMT_DRAWINGS_POS_CURRENT_VAR', 'PREV_AMT_DOWN_PAYMENT_SUM', 'ACTIVE_AMT_CREDIT_SUM_LIMIT_MEAN', 'INS_SK_ID_PREV_MIN', 'APPROVED_AMT_ANNUITY_MEAN', 'DEF_30_CNT_SOCIAL_CIRCLE', 'INS_ins DAYS_ENTRY_PAYMENT - DAYS_INSTALMENT_VAR', 'PREV_HOUR_APPR_PROCESS_START_MEAN', 'app AMT_CREDIT - AMT_GOODS_PRICE', 'app AMT_INCOME_TOTAL / CNT_FAM_MEMBERS', 'app EXT_SOURCE mean', 'YEARS_BEGINEXPLUATATION_MODE', 'PREV_NAME_GOODS_CATEGORY_Mobile_MEAN', 'PREV_CNT_PAYMENT_VAR', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MIN', 'CLOSED_DAYS_CREDIT_UPDATE_MIN', 'REFUSED_AMT_DOWN_PAYMENT_SUM', 'CLOSED_AMT_CREDIT_SUM_VAR', 'POS_CNT_INSTALMENT_VAR', 'POS_SK_DPD_DEF_MEAN', 'APPROVED_NAME_YIELD_GROUP_low_normal_MEAN', 'PREV_prev DAYS_FIRST_DRAWING - DAYS_FIRST_DUE_SUM', 'app EXT_SOURCE_3 * DAYS_EMPLOYED', 'APPROVED_AMT_ANNUITY_MAX', 'CLOSED_DAYS_CREDIT_UPDATE_MAX', 'PREV_NFLAG_INSURED_ON_APPROVAL_VAR', 'DAYS_EMPLOYED', 'REFUSED_NAME_PAYMENT_TYPE_XNA_MEAN', 'INS_ins DAYS_ENTRY_PAYMENT - DAYS_INSTALMENT_MEAN', 'CARD_card AMT_BALANCE - AMT_TOTAL_RECEIVABLE_VAR', 'REFUSED_prev AMT_APPLICATION - AMT_CREDIT_VAR', 'PREV_NAME_YIELD_GROUP_high_MEAN', 'PREV_RATE_DOWN_PAYMENT_SUM', 'APPROVED_DAYS_DECISION_MAX', 'ACTIVE_AMT_CREDIT_MAX_OVERDUE_SUM', 'ACTIVE_AMT_CREDIT_SUM_MIN', 'APPROVED_AMT_CREDIT_MIN', 'app EXT_SOURCE_2 / DAYS_BIRTH', 'APPROVED_NAME_YIELD_GROUP_high_MEAN', 'PREV_DAYS_LAST_DUE_1ST_VERSION_SUM', 'app AMT_INCOME_TOTAL / 12 - AMT_ANNUITY', 'REGION_RATING_CLIENT_W_CITY', 'CLOSED_bureau DAYS_CREDIT - DAYS_ENDDATE_FACT_MAX', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_VAR', 'CARD_card AMT_TOTAL_RECEIVABLE - AMT_RECEIVABLE_PRINCIPAL_VAR', 'INS_SK_ID_PREV_SUM', 'PREV_NAME_PRODUCT_TYPE_walk-in_MEAN', 'CARD_SK_DPD_DEF_MEAN', 'PREV_AMT_DOWN_PAYMENT_MEAN', 'REFUSED_AMT_ANNUITY_MAX', 'app AMT_CREDIT / AMT_ANNUITY', 'PREV_prev AMT_APPLICATION / AMT_CREDIT_MEAN', 'REFUSED_NAME_CONTRACT_TYPE_Cash loans_MEAN', 'CARD_AMT_PAYMENT_CURRENT_MEAN', 'POS_SK_DPD_VAR', 'BURO_CREDIT_TYPE_Credit card_MEAN', 'CARD_SK_ID_CURR_SUM', 'DAYS_BIRTH', 'APARTMENTS_AVG', 'APPROVED_SK_ID_PREV_MIN', 'APPROVED_NAME_PRODUCT_TYPE_walk-in_MEAN', 'INS_NUM_INSTALMENT_NUMBER_VAR', 'INS_DAYS_ENTRY_PAYMENT_VAR', 'PREV_DAYS_TERMINATION_MEAN', 'PREV_DAYS_LAST_DUE_SUM', 'CARD_AMT_PAYMENT_TOTAL_CURRENT_VAR', 'BURO_AMT_CREDIT_SUM_DEBT_VAR', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MEAN', 'BURO_DAYS_CREDIT_ENDDATE_SUM', 'EXT_SOURCE_3', 'CARD_card AMT_BALANCE - AMT_RECEIVABLE_PRINCIPAL_MEAN', 'CLOSED_Non_zero_DPD_cnt_MIN_MIN', 'APPROVED_AMT_APPLICATION_MAX', 'REFUSED_SK_ID_PREV_MAX', 'APPROVED_HOUR_APPR_PROCESS_START_MAX', 'POS_CNT_INSTALMENT_FUTURE_VAR', 'ACTIVE_SK_ID_CURR_SUM', 'POS_SK_ID_PREV_MIN', 'INS_AMT_INSTALMENT_MEAN', 'YEARS_BEGINEXPLUATATION_AVG', 'ACTIVE_DAYS_CREDIT_VAR', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MEAN', 'CARD_AMT_BALANCE_MIN', 'BURO_DAYS_CREDIT_ENDDATE_MAX', 'PREV_prev AMT_GOODS_PRICE - AMT_CREDIT_MEAN', 'POS_MONTHS_BALANCE_MEAN', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MEAN', 'CLOSED_DPD_0 / Month_MIN_MIN', 'INS_AMT_INSTALMENT_MAX', 'NAME_FAMILY_STATUS', 'INS_AMT_INSTALMENT_MIN', 'BURO_DAYS_CREDIT_VAR', 'POS_CNT_INSTALMENT_FUTURE_MEAN', 'PREV_DAYS_LAST_DUE_1ST_VERSION_MEAN', 'POS_CNT_INSTALMENT_FUTURE_MAX', 'PREV_SELLERPLACE_AREA_MEAN', 'INS_AMT_PAYMENT_MIN', 'BURO_bureau DAYS_CREDIT - CREDIT_DAY_OVERDUE_MAX', 'CARD_card AMT_BALANCE - AMT_RECEIVABLE_PRINCIPAL_MIN', 'CARD_card AMT_BALANCE - AMT_RECIVABLE_MAX', 'app EXT_SOURCE_1 * DAYS_EMPLOYED', 'ACTIVE_SK_ID_CURR_SIZE', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MEAN', 'CLOSED_DAYS_ENDDATE_FACT_MAX', 'INS_DAYS_INSTALMENT_MEAN', 'ACTIVE_SK_ID_BUREAU_MIN_MAX', 'ACTIVE_AMT_CREDIT_SUM_MAX', 'ACTIVE_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MAX', 'POS_SK_DPD_MEAN', 'REFUSED_WEEKDAY_APPR_PROCESS_START_TUESDAY_MEAN', 'INS_DAYS_INSTALMENT_SUM', 'PREV_AMT_APPLICATION_MEAN', 'REFUSED_prev AMT_APPLICATION - AMT_CREDIT_MIN', 'PREV_prev missing_SUM', 'PREV_prev AMT_APPLICATION - AMT_CREDIT_MAX', 'BURO_STATUS_C_MEAN_MEAN', 'BURO_DAYS_ENDDATE_FACT_MAX', 'BURO_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_VAR', 'POS_CNT_INSTALMENT_FUTURE_SUM', 'REFUSED_RATE_DOWN_PAYMENT_SUM', 'CARD_card AMT_RECIVABLE - AMT_RECEIVABLE_PRINCIPAL_MAX', 'PREV_NAME_CONTRACT_STATUS_Refused_MEAN', 'EXT_SOURCE_2', 'ACTIVE_AMT_CREDIT_SUM_DEBT_VAR', 'REFUSED_prev missing_VAR', 'BURO_AMT_CREDIT_MAX_OVERDUE_VAR', 'POS_CNT_INSTALMENT_MEAN', 'POS_SK_DPD_DEF_VAR', 'PREV_CODE_REJECT_REASON_HC_MEAN', 'CARD_card AMT_BALANCE - AMT_RECEIVABLE_PRINCIPAL_VAR', 'PREV_DAYS_LAST_DUE_VAR', 'CLOSED_MONTHS_BALANCE_MIN_MEAN', 'PREV_NAME_TYPE_SUITE_NaN_MEAN', 'PREV_NAME_CLIENT_TYPE_New_MEAN', 'WALLSMATERIAL_MODE', 'INS_DAYS_ENTRY_PAYMENT_MEAN', 'PREV_DAYS_LAST_DUE_1ST_VERSION_MAX', 'POS_MONTHS_BALANCE_MIN', 'BURO_CREDIT_TYPE_Consumer credit_MEAN', 'PREV_CNT_PAYMENT_SUM', 'DAYS_REGISTRATION', 'ACTIVE_CREDIT_TYPE_Credit card_MEAN', 'APPROVED_prev AMT_APPLICATION / AMT_CREDIT_SUM', 'BURO_SK_ID_CURR_SUM', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_VAR', 'PREV_SK_ID_PREV_MAX', 'CARD_AMT_RECEIVABLE_PRINCIPAL_MEAN', 'PREV_DAYS_DECISION_SUM', 'ACTIVE_DAYS_CREDIT_UPDATE_VAR', 'REFUSED_SK_ID_PREV_SUM', 'BURO_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MEAN', 'BURO_AMT_CREDIT_SUM_OVERDUE_MAX', 'APPROVED_SK_ID_PREV_SUM', 'APPROVED_HOUR_APPR_PROCESS_START_SUM', 'CLOSED_DAYS_CREDIT_ENDDATE_MAX', 'REFUSED_SK_ID_CURR_SUM', 'CLOSED_AMT_CREDIT_SUM_SUM', 'INS_DAYS_ENTRY_PAYMENT_MAX', 'PREV_prev missing_MEAN', 'BURO_DAYS_CREDIT_MAX', 'PREV_AMT_CREDIT_SUM', 'app AMT_INCOME_TOTAL / CNT_CHILDREN', 'BURO_bureau DAYS_CREDIT_ENDDATE - DAYS_ENDDATE_FACT_MEAN', 'BURO_bureau DAYS_CREDIT - DAYS_ENDDATE_FACT_SUM', 'BURO_CREDIT_TYPE_Microloan_MEAN', 'PREV_AMT_GOODS_PRICE_MIN', 'PREV_PRODUCT_COMBINATION_Cash Street: high_MEAN', 'PREV_NAME_PAYMENT_TYPE_XNA_MEAN', 'REFUSED_AMT_GOODS_PRICE_VAR', 'APPROVED_DAYS_DECISION_VAR', 'CLOSED_AMT_CREDIT_SUM_MAX', 'REFUSED_prev AMT_APPLICATION / AMT_CREDIT_MAX', 'PREV_prev missing_VAR', 'INS_AMT_PAYMENT_MAX', 'ACTIVE_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_SUM', 'CARD_card AMT_BALANCE - AMT_RECEIVABLE_PRINCIPAL_MAX', 'PREV_prev AMT_APPLICATION / AMT_CREDIT_MAX', 'POS_CNT_INSTALMENT_MAX', 'BURO_DAYS_CREDIT_ENDDATE_MEAN', 'INS_ins DAYS_ENTRY_PAYMENT - DAYS_INSTALMENT_SUM', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MEAN', 'PREV_NAME_PAYMENT_TYPE_Cash through the bank_MEAN', 'POS_SK_ID_PREV_MAX', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_VAR', 'APPROVED_NAME_CLIENT_TYPE_New_MEAN', 'CLOSED_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MIN', 'CARD_CNT_DRAWINGS_ATM_CURRENT_VAR', 'PREV_NAME_CASH_LOAN_PURPOSE_Repairs_MEAN', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MAX', 'app EXT_SOURCE_3 / DAYS_BIRTH', 'app EXT_SOURCE_2 * DAYS_EMPLOYED', 'PREV_DAYS_DECISION_MEAN', 'BURO_AMT_CREDIT_SUM_OVERDUE_MEAN', 'INS_NUM_INSTALMENT_VERSION_SUM', 'PREV_DAYS_TERMINATION_MIN', 'PREV_NAME_CONTRACT_STATUS_Approved_MEAN', 'INS_DAYS_ENTRY_PAYMENT_MIN', 'BURO_DAYS_CREDIT_UPDATE_VAR', 'BURO_AMT_CREDIT_SUM_SUM', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MIN', 'REFUSED_SELLERPLACE_AREA_SUM', 'app AMT_CREDIT / AMT_GOODS_PRICE', 'BURO_DPD_0 / Month_MIN_MEAN', 'ACTIVE_AMT_CREDIT_SUM_DEBT_MIN', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MAX', 'CARD_CNT_DRAWINGS_ATM_CURRENT_MEAN', 'PREV_prev AMT_GOODS_PRICE - AMT_CREDIT_SUM', 'PREV_AMT_DOWN_PAYMENT_VAR', 'PREV_prev AMT_APPLICATION / AMT_CREDIT_MIN', 'ACTIVE_DPD_0_cnt_MIN_MEAN', 'PREV_DAYS_FIRST_DUE_MEAN', 'CARD_AMT_DRAWINGS_ATM_CURRENT_MEAN', 'CARD_CNT_DRAWINGS_POS_CURRENT_VAR', 'REGION_POPULATION_RELATIVE', 'BURO_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MAX', 'PREV_DAYS_TERMINATION_SUM', 'APPROVED_PRODUCT_COMBINATION_Cash X-Sell: low_MEAN', 'BURO_AMT_CREDIT_SUM_MAX', 'BURO_SK_ID_BUREAU_SIZE_MEAN', 'REFUSED_prev missing_SUM', 'APPROVED_SK_ID_CURR_SUM', 'CLOSED_bureau DAYS_CREDIT_ENDDATE - DAYS_ENDDATE_FACT_MEAN', 'INS_NUM_INSTALMENT_VERSION_MAX', 'NAME_EDUCATION_TYPE', 'app DAYS_LAST_PHONE_CHANGE / DAYS_BIRTH', 'CLOSED_bureau DAYS_CREDIT_ENDDATE - DAYS_ENDDATE_FACT_VAR', 'APPROVED_AMT_APPLICATION_VAR', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MIN', 'PREV_DAYS_LAST_DUE_1ST_VERSION_VAR', 'INS_AMT_INSTALMENT_SUM', 'app EXT_SOURCE_1 / DAYS_BIRTH', 'INS_NUM_INSTALMENT_NUMBER_SUM', 'PREV_AMT_APPLICATION_MIN', 'ACTIVE_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MIN', 'app EXT_SOURCE prod', 'CLOSED_DAYS_CREDIT_VAR', 'PREV_NAME_YIELD_GROUP_low_normal_MEAN', 'INS_ins DAYS_ENTRY_PAYMENT - DAYS_INSTALMENT_MAX', 'REFUSED_DAYS_DECISION_SUM', 'CARD_card AMT_TOTAL_RECEIVABLE - AMT_RECEIVABLE_PRINCIPAL_MAX', 'PREV_prev DAYS_TERMINATION less -500_VAR', 'BURO_STATUS_C_MEAN_MAX', 'CLOSED_AMT_CREDIT_SUM_MEAN', 'ACTIVE_STATUS_X_MEAN_VAR', 'app AMT_INCOME_TOTAL - AMT_GOODS_PRICE', 'ACTIVE_DAYS_CREDIT_MEAN', 'PREV_prev AMT_APPLICATION / AMT_CREDIT_SUM', 'REFUSED_DAYS_DECISION_MAX', 'HOUR_APPR_PROCESS_START', 'PREV_prev AMT_APPLICATION - AMT_CREDIT_MIN', 'APPROVED_CNT_PAYMENT_SUM', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MIN', 'ACTIVE_AMT_CREDIT_SUM_OVERDUE_MAX', 'CARD_CNT_DRAWINGS_CURRENT_VAR', 'DEF_60_CNT_SOCIAL_CIRCLE', 'APPROVED_RATE_DOWN_PAYMENT_VAR', 'PREV_NAME_YIELD_GROUP_middle_MEAN', 'CLOSED_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MAX', 'BURO_AMT_CREDIT_SUM_DEBT_MEAN', 'BURO_AMT_CREDIT_SUM_OVERDUE_VAR', 'LANDAREA_AVG', 'POS_SK_ID_PREV_SIZE', 'app EXT_SOURCE std', 'ACTIVE_AMT_CREDIT_MAX_OVERDUE_MAX', 'CLOSED_DAYS_CREDIT_UPDATE_VAR', 'ACTIVE_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_SUM', 'BURO_SK_ID_BUREAU_MIN_MAX', 'app EXT_SOURCE_1 * EXT_SOURCE_3', 'PREV_DAYS_LAST_DUE_MEAN', 'REFUSED_AMT_CREDIT_VAR', 'ACTIVE_AMT_CREDIT_MAX_OVERDUE_VAR', 'CLOSED_DAYS_CREDIT_UPDATE_MEAN', 'BURO_bureau DAYS_CREDIT - DAYS_ENDDATE_FACT_MEAN', 'APPROVED_prev AMT_GOODS_PRICE - AMT_CREDIT_MAX', 'APARTMENTS_MODE', 'PREV_prev AMT_APPLICATION - AMT_CREDIT_SUM', 'POS_SK_DPD_SUM', 'INS_ins AMT_INSTALMENT - AMT_PAYMENT_MEAN', 'REFUSED_SELLERPLACE_AREA_MIN', 'APPROVED_NAME_SELLER_INDUSTRY_Connectivity_MEAN', 'PREV_HOUR_APPR_PROCESS_START_MIN', 'REFUSED_AMT_CREDIT_MIN', 'PREV_PRODUCT_COMBINATION_POS mobile with interest_MEAN', 'INS_ins AMT_PAYMENT / AMT_INSTALMENT_SUM', 'BURO_DAYS_CREDIT_UPDATE_SUM', 'BURO_bureau DAYS_CREDIT - DAYS_ENDDATE_FACT_MAX', 'PREV_prev AMT_GOODS_PRICE - AMT_CREDIT_MAX', 'ACTIVE_DAYS_CREDIT_UPDATE_SUM', 'CLOSED_SK_ID_BUREAU_SIZE_MIN', 'APPROVED_prev missing_MEAN', 'PREV_AMT_ANNUITY_MIN', 'CARD_card AMT_RECIVABLE - AMT_RECEIVABLE_PRINCIPAL_MEAN', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_OVERDUE_MIN', 'CARD_CNT_DRAWINGS_POS_CURRENT_MEAN', 'APPROVED_prev AMT_APPLICATION - AMT_CREDIT_MAX', 'ACTIVE_DAYS_CREDIT_ENDDATE_MEAN', 'FLAG_DOCUMENT_3', 'DAYS_ID_PUBLISH', 'INS_DAYS_ENTRY_PAYMENT_SUM', 'ACTIVE_DAYS_CREDIT_ENDDATE_SUM', 'INS_ins AMT_INSTALMENT - AMT_PAYMENT_MAX', 'ACTIVE_STATUS_0_MEAN_SUM', 'APPROVED_AMT_DOWN_PAYMENT_MAX', 'APPROVED_AMT_GOODS_PRICE_MIN', 'APPROVED_AMT_CREDIT_MEAN', 'POS_MONTHS_BALANCE_VAR', 'APPROVED_SELLERPLACE_AREA_MEAN', 'APPROVED_CNT_PAYMENT_VAR', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_SUM', 'LIVINGAREA_AVG', 'REFUSED_prev missing_MEAN', 'ORGANIZATION_TYPE', 'BURO_AMT_CREDIT_SUM_MEAN', 'CLOSED_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MIN', 'BURO_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MEAN', 'CARD_card AMT_TOTAL_RECEIVABLE - AMT_RECEIVABLE_PRINCIPAL_MIN', 'BURO_DPD_0 / Month_MIN_MAX', 'PREV_prev AMT_APPLICATION / AMT_CREDIT_VAR', 'INS_SK_ID_CURR_SUM', 'PREV_prev DAYS_FIRST_DRAWING - DAYS_FIRST_DUE_MEAN', 'APPROVED_HOUR_APPR_PROCESS_START_MEAN', 'APPROVED_AMT_DOWN_PAYMENT_SUM', 'APPROVED_AMT_CREDIT_VAR', 'PREV_DAYS_FIRST_DUE_MIN', 'OWN_CAR_AGE', 'CLOSED_bureau DAYS_CREDIT_UPDATE - DAYS_CREDIT_ENDDATE_MEAN', 'CARD_card AMT_BALANCE - AMT_RECIVABLE_MEAN', 'ACTIVE_DAYS_CREDIT_ENDDATE_MAX', 'APPROVED_AMT_APPLICATION_MEAN', 'BURO_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_VAR', 'APPROVED_CNT_PAYMENT_MEAN', 'APPROVED_prev AMT_GOODS_PRICE - AMT_CREDIT_MEAN', 'BURO_AMT_CREDIT_SUM_DEBT_MIN', 'APPROVED_AMT_DOWN_PAYMENT_MEAN', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_SUM', 'CLOSED_SK_ID_CURR_SUM', 'ACTIVE_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_VAR', 'INS_SK_ID_PREV_MAX', 'BURO_AMT_CREDIT_SUM_DEBT_SUM', 'APPROVED_prev AMT_GOODS_PRICE - AMT_CREDIT_SUM', 'ACTIVE_AMT_CREDIT_SUM_DEBT_MEAN', 'CLOSED_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_OVERDUE_SUM', 'APPROVED_AMT_DOWN_PAYMENT_VAR', 'CODE_GENDER', 'AMT_GOODS_PRICE', 'CLOSED_bureau DAYS_CREDIT - DAYS_ENDDATE_FACT_SUM', 'PREV_CNT_PAYMENT_MEAN', 'POS_SK_ID_CURR_SUM', 'app EXT_SOURCE_1 * EXT_SOURCE_2', 'CARD_card AMT_BALANCE - AMT_TOTAL_RECEIVABLE_MEAN', 'REFUSED_CNT_PAYMENT_MAX', 'REFUSED_prev AMT_APPLICATION - AMT_CREDIT_MAX', 'ACTIVE_MONTHS_BALANCE_MIN_MIN', 'ACTIVE_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MEAN', 'CARD_AMT_DRAWINGS_CURRENT_MEAN', 'POS_SK_DPD_DEF_MAX', 'REFUSED_AMT_ANNUITY_MIN', 'BURO_AMT_CREDIT_MAX_OVERDUE_MEAN', 'INS_ins AMT_PAYMENT / AMT_INSTALMENT_MEAN', 'BURO_bureau DAYS_CREDIT - DAYS_CREDIT_ENDDATE_MIN', 'INS_NUM_INSTALMENT_VERSION_VAR', 'INS_AMT_PAYMENT_MEAN', 'INS_DAYS_INSTALMENT_VAR', 'app most popular AMT_GOODS_PRICE', 'PREV_AMT_ANNUITY_MEAN', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MEAN', 'REFUSED_DAYS_DECISION_VAR', 'app DAYS_EMPLOYED - DAYS_BIRTH', 'ACTIVE_AMT_CREDIT_SUM_DEBT_SUM', 'YEARS_BEGINEXPLUATATION_MEDI', 'POS_SK_ID_PREV_VAR', 'ACTIVE_AMT_CREDIT_SUM_OVERDUE_VAR', 'POS_NAME_CONTRACT_STATUS_Active_MEAN', 'CLOSED_DAYS_CREDIT_ENDDATE_MEAN', 'APPROVED_prev AMT_APPLICATION / AMT_CREDIT_MIN', 'APPROVED_DAYS_LAST_DUE_1ST_VERSION_SUM', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_DEBT_MIN', 'PREV_CHANNEL_TYPE_AP+ (Cash loan)_MEAN', 'ACTIVE_DAYS_CREDIT_UPDATE_MAX', 'INS_ins AMT_INSTALMENT - AMT_PAYMENT_SUM', 'ACTIVE_AMT_CREDIT_SUM_MEAN', 'PREV_RATE_DOWN_PAYMENT_MEAN', 'PREV_CODE_REJECT_REASON_XAP_MEAN', 'PREV_HOUR_APPR_PROCESS_START_MAX', 'PREV_prev AMT_GOODS_PRICE - AMT_CREDIT_VAR', 'ACTIVE_DAYS_CREDIT_ENDDATE_MIN', 'REFUSED_NAME_PORTFOLIO_XNA_MEAN', 'CARD_card AMT_DRAWINGS_CURRENT - AMT_DRAWINGS_OTHER_CURRENT_MEAN', 'BURO_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_MAX', 'TOTALAREA_MODE', 'REG_CITY_NOT_LIVE_CITY', 'ACTIVE_bureau AMT_CREDIT_SUM - AMT_CREDIT_SUM_LIMIT_SUM', 'CARD_AMT_PAYMENT_CURRENT_MAX', 'PREV_prev AMT_APPLICATION - AMT_CREDIT_VAR', 'APPROVED_AMT_ANNUITY_SUM']
    data = data[['SK_ID_CURR'] + features]
